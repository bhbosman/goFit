...
func (obj *DiveApneaAlarm) MsgNumber() uint16 {
	return uint16(MesgNum_DiveApneaAlarm)
}

func (obj *DiveApneaAlarm) Read(data []byte, md *messages.MessageDefinition) error {
	return nil
}

var fieldMapForDiveApneaAlarm = map[uint16]registration.DefinedFields{
...
func init() {
	_ = registration.RegisterMessage(
		uint16(MesgNum_DiveApneaAlarm),
		fieldMapForDiveApneaAlarm,
		func() (registration.IFitMessage, error) {
			return &DiveApneaAlarm{}, nil
		},
	)
}
