...
func (obj *AntTx) MsgNumber() uint16 {
	return uint16(MesgNum_AntTx)
}

func (obj *AntTx) Read(data []byte, md *messages.MessageDefinition) error {
	return nil
}

var fieldMapForAntTx = map[uint16]registration.DefinedFields{
