...
%type <Identifier> any_declarator scoped_name Identifier RWshort RWint16 RWuint16 RWlong RWint32 RWint64 RWint8 RWuint8 RWsequence
%type <Identifier> RWuint32 RWfloat RWdouble RWunsigned RWuint64 simple_declarator RWconst RWstruct RWenum RWtypedef RWstring RWwstring
%type <Definition> struct_def struct_forward_dcl struct_dcl constr_type_dcl type_dcl definition const_dcl enum_dcl typedef_dcl union_dcl bitset_dcl bitmask_dcl DefineExpression
...
%type <TypeSpec> const_type integer_type base_type_spec simple_type_spec type_spec
...
%type <TypeSpec> floating_pt_type fixed_pt_const_type char_type wide_char_type boolean_type octet_type string_type
%type <TypeSpec> wide_string_type any_type object_type value_base_type
...
struct_def:
	RWstruct Identifier '{' memberPlus '}'
	{
		...
		$1 = UnionData[string]{"", 0, 0, ""}
		$2 = UnionData[string]{"", 0, 0, ""}
		$4 = UnionData[[]Member]{"", -1, -1, $4.data[:0]}
	}
	| RWstruct Identifier ':' scoped_name '{' memberStar '}'
	{
		...
		$1 = UnionData[string]{"", 0, 0, ""}
		$2 = UnionData[string]{"", 0, 0, ""}
		$6 = UnionData[[]Member]{"", -1, -1, $6.data[:0]}
	}
	| RWstruct Identifier '{' '}'
	{
		$$ = UnionData[IBaseDefinition]{
...
memberStar:
	...
	{
		$$ = $1
		$1 = UnionData[[]Member]{"", -1, -1, $1.data[:0]}
	}
...
member:
	type_spec declarators ';'
	{
		...
		$1 = UnionData[ITypeSpec]{"", -1, -1, nil}
		$2 = UnionData[[]Declarator]{"", -1, -1, $2.data[:0]}
...
enum_dcl:
	RWenum Identifier '{' enumerators '}'
	{
		...
		$1 = UnionData[string]{"", 0, 0, ""}
		$2 = UnionData[string]{"", 0, 0, ""}
		$4 = UnionData[[]Enumerator]{"", -1, -1, $4.data[:0]}
	}
enumerators:
	enumerator
	{
